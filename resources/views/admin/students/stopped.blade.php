    ...
    <div class="page-header border-bottom-0">
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> - الطلاب المعطلين</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header header-elements-inline ">
                        <h5 class="card-title">ما تم تعطيلة من الطلاب</h5>
                                                    ...
                                                    <div class="list-icons">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                               ...
                                                               !!}
                                                                <button class="dropdown-item"><i class="icon-user-cancel" style="color: #fa0000"></i> حذف المستخدم {{$student->name}}</button>
                                                                {!! Form::close() !!}
                                                                {!! Form::open(array(
                                                                       'style' => 'display: inline-block;',
                                                                       'method' => 'DELETE',
                                                                ...
                                                                {!! Form::close() !!}
                                                                <a href="{{route('students.edit',$student->id)}}" class="dropdown-item"><i class="icon-pencil5" style="color: #87caff"></i>  تعديل المستخدم {{$student->name}}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
