    ...
    <div class="page-header border-bottom-0">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('students.index')}}" class="breadcrumb-item"><i class="icon-students4 mr-2"></i> الطالبين</a>
                    <span class="breadcrumb-item active"> تعديل الطالب "{{$model->name}}"</span>
                </div>
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> -  تعديل الطالب "{{$model->name}}"</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title"> التعديل على الطالب "{{$model->name}}"</h5>
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('students.update',$model->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
