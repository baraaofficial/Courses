    ...
    <div class="page-header border-bottom-0">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">بحث في بيئات العمل</span>
                </div>
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> - بيئات العمل المحذوفة</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="mb-3">إبحث في بحث في بيئات العمل</h5>
            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header header-elements-inline ">
                        <h5 class="card-title">جميع بيئات العمل المحذوفة</h5>
                    ...
                    <table class="table datatable-button-print-rows">
                        ...
                        @if (count($frameworks) == 0)
                            ...
                            <div class="alert alert-info alert-styled-left alert-dismissible">
                                ...
                                <span class="font-weight-semibold">لا توجد بيانات متطابقة!</span>  عليك بإدخال بيانات ذات صلة .
                            </div>
                        @endif
                        <tbody>
                        ...
                        @foreach($frameworks as $framework)
                            <tr>
                                ...
                                <td title="{{$framework->created_at->format('H:i:s')}}">{{$framework->created_at->format('Y-m-d')}}</td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{route('framework.recovery', $framework->id)}}" class="dropdown-item"><i class="icon-rotate-cw2"></i> استرجاع  {{$framework->name_ar}}</a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
