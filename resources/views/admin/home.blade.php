                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('admin/global_assets/images/brands/youtube.png')}}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('admin/global_assets/images/brands/spotify.png')}}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('admin/global_assets/images/brands/twitter.png')}}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('admin/global_assets/images/brands/bing.png')}}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('admin/global_assets/images/brands/amazon.png')}}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{asset('admin/global_assets/images/brands/dribbble.png')}}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
