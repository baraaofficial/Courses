    ...
    <div class="page-header border-bottom-0">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('levels.index')}}" class="breadcrumb-item"><i class="icon-stats-bars4"></i> المستويات</a>
                    <span class="breadcrumb-item active">إضافة مستوي جديد</span>
                </div>
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> - إضافة مستوي جديد</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">إضافة مستوي جديد</h5>
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('levels.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">بيانات المستوي</legend>
