    ...
    <div class="page-header border-bottom-0">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">المقالات المتوقفة</span>
                </div>
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> - المقالات المتوقفة</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="font-weight-semibold mb-1">
                            <a href="{{route('articles.show',$article->id)}}" class="text-default">{{$article->title_ar}}</a>
                        </h5>
