    ...
    <div class="page-header border-bottom-0">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('articles.index')}}" class="breadcrumb-item"><i class="icon-sphere3 mr-2"></i> المقالات</a>
                    <span class="breadcrumb-item active">  تعديل مقال {{$model->title_ar}}</span>
                </div>
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> -   تعديل مقال {{$model->name_شق}}</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title"> التعديل على مقال {{$model->title_ar}}</h5>
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('articles.update',$model->id)}}" method="POST" files="true" enctype="multipart/form-data">
                    ...
                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">بيانات المقالة</legend>
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary ml-3" > تعديل مقال {{$model->name}} <i class="icon-paperplane ml-2"></i></button>
                    </div>
                </form>
            </div>
        </div>
