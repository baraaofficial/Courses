    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('languages.update',$model->id)}}" method="POST" files="true" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary ml-3" > تعديل لغة {{$model->name}} <i class="icon-paperplane ml-2"></i></button>
                    </div>
                </form>
            </div>
        </div>
