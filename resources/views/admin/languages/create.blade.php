...
@inject('model', 'App\Models\Language')
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('settings.index')}}" class="breadcrumb-item"><i class="icon-sphere3 mr-2"></i> اللغات</a>
                    <span class="breadcrumb-item active">إضافة لغة جديدة</span>
                </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">إضافة لغة جديدة</h5>
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('languages.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset class="mb-3">
