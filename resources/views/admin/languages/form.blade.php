...
<div class="tab-content">
    <div class="tab-pane show active" id="ar">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-3">إسم اللغة <span class="text-danger">*</span></label>
            <div class="col-lg-9">
                <div class="form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <input type="text" name="{{$inputname_ar}}" id="name" class="form-control maxlength-badge-position @error($inputname_ar) border-danger-400 @enderror" maxlength="199" placeholder="إسم اللغة" value="{{Request::old($inputname_ar) ? Request::old($inputname_ar) : $model->$inputname_ar}}" required>
                        @error($inputname_ar)
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-3">وصف اللغه <span class="text-danger">*</span></label>
            <div class="col-lg-9">
        ...
        <div class="form-group row">
            <label class="col-lg-2 col-form-label font-weight-semibold">صورة اللغة <span class="text-danger">*</span></label>
            <div class="col-lg-10">
                ...
                <span class="form-text text-muted">أضف صورة للغه</span>
            </div>
        </div>
        <!-- Select2 select -->
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <select name="{{$input}}" data-placeholder="إختر حالة اللغة" class="form-control form-control-select2" required data-fouc>
                    <option></option>
    ...
    <div class="tab-pane show" id="en">
        ...
        <div class="form-group row" dir="ltr">
            <label class="col-form-label col-lg-3">Language name  <span class="text-danger">*</span></label>
            <div class="col-lg-9">
                <div class="form-group-feedback form-group-feedback-left">
                    <div class="input-group">
                        <span class="input-group-prepend">
        ...
        <div class="form-group row" dir="ltr">
            <label class="col-form-label col-lg-3">Language description <span class="text-danger">*</span></label>
            <div class="col-lg-9">
