    ...
    <div class="page-header border-bottom-0">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">المدرسين</span>
                </div>
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> - المدرسين</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>

            <div class="header-elements d-none mb-3 mb-md-0">
                <div class="d-flex justify-content-center">
                    <a href="{{route('teachers.create')}}" class="btn btn-link btn-float text-default">
                ...
                <form action="" method="get">
                    <div class="input-group mb-3">
                        <div class="form-group-feedback form-group-feedback-left">
                            <input type="text" class="form-control form-control-lg" name="keyword" value="" placeholder="إترك بحثك هنا وليكن اسم المدرس او البريد الإلكتروني">
            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header header-elements-inline ">
                        <h5 class="card-title">جميع المدرسين بالموقع</h5>
                                ...
                                <div class="card bg-slate-600" style="background-image: url(admin/global_assets/images/backgrounds/panel_bg.png); background-size: contain;">
                                    <div class="card-body text-center">
                                        <div class="card-img-actions d-inline-block mb-3">
                                            <img class="img-fluid rounded-circle" src="{{$teacher->photo}}" width="170" height="170" alt="{{$teacher->photo}}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                {!! Form::open(array(
                                                                    ...
                                                                    'method' => 'DELETE',
                                                                    'onsubmit' => "return confirm('".trans("هل أنت متأكد من حذف $teacher->name ؟")."');",
                                                                    'route' => ['teachers.destroy', $teacher->id]))
                                                               !!}
                                                                <button class="dropdown-item"><i class="icon-user-cancel" style="color: #fa0000"></i> حذف المدرس {{$teacher->name}}</button>
                                                                {!! Form::close() !!}
                                                                {!! Form::open(array(
                                                                       'style' => 'display: inline-block;',
                                                                       'method' => 'DELETE',
                                                                       'onsubmit' => "return confirm('".trans("هل أنت متأكد من حذف $teacher->name نهائياَ؟")."');",
                                                                       'route' => ['student.forcedelete', $teacher->id]))
                                                                  !!}
                                                                <button class="dropdown-item"><i class="icon-user-cancel" style="color: #fa0000"></i> حذف {{$teacher->name}} نهائيا </button>

                                                                {!! Form::close() !!}

                                                                <a href="{{route('teachers.edit',$teacher->id)}}" class="dropdown-item"><i class="icon-pencil5" style="color: #87caff"></i>  تعديل المدرس {{$teacher->name}}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
