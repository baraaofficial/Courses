    ...
    <div class="page-header border-bottom-0">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline border-0">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('teachers.index')}}" class="breadcrumb-item"><i class="icon-users"></i>الطلاب</a>
                    <span class="breadcrumb-item active">إضافة مدرس جديد</span>
                </div>
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> - إضافة مدرس جديد</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">أنشئ مدرس جديد</h5>
            ...
            <div class="card-body">
                ...
                <form class="form-validate-jquery" action="{{route('teachers.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset class="mb-3">
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary ml-3" >إضافة المدرس <i class="icon-paperplane ml-2"></i></button>
                    </div>
                </form>
            </div>
        </div>
