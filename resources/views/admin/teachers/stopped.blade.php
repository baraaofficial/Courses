    ...
    <div class="page-header border-bottom-0">
        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">الرئيسية</span> - المدرسين المعطلين</h4>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
                ...
                <form action="" method="get">
                    <div class="input-group mb-3">
                        <div class="form-group-feedback form-group-feedback-left">
                            <input type="text" class="form-control form-control-lg" name="keyword" placeholder="إترك بحثك هنا وليكن اسم الطالب او البريد الإلكتروني">
            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header header-elements-inline ">
                        <h5 class="card-title">ما تم تعطيلة من المدرسين</h5>
                                                    ...
                                                    <div class="list-icons">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                               ...
                                                               !!}
                                                                <button class="dropdown-item"><i class="icon-user-cancel" style="color: #fa0000"></i> حذف المستخدم {{$teacher->name}}</button>
                                                                {!! Form::close() !!}
                                                                {!! Form::open(array(
                                                                       'style' => 'display: inline-block;',
                                                                       'method' => 'DELETE',
                                                                ...
                                                                {!! Form::close() !!}
                                                                <a href="{{route('teachers.edit',$teacher->id)}}" class="dropdown-item"><i class="icon-pencil5" style="color: #87caff"></i>  تعديل المستخدم {{$teacher->name}}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
