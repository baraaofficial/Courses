...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $Charts_today_users_trashed = User::onlyTrashed()->whereDate('created_at', today())->count();
        $Charts_yesterday_users_trashed = User::onlyTrashed()->whereDate('created_at', today()->subDays(2))->count();
        $Charts_users_trashed_3_days_ago = User::onlyTrashed()->whereDate('created_at', today()->subDays(3))->count();
        $Charts_users_trashed_4_days_ago = User::onlyTrashed()->whereDate('created_at', today()->subDays(4))->count();
        $Charts_users_trashed_5_days_ago = User::onlyTrashed()->whereDate('created_at', today()->subDays(5))->count();
        $Charts_users_trashed_6_days_ago = User::onlyTrashed()->whereDate('created_at', today()->subDays(6))->count();
        $Charts_users_trashed_7_days_ago = User::onlyTrashed()->whereDate('created_at', today()->subDays(7))->count();
        // End chart users block


        // Start chart users block
        $Charts_today_users_block = User::status()->whereDate('created_at', today())->count();
        $Charts_yesterday_users_block = User::status()->whereDate('created_at', today()->subDays(2))->count();
        $Charts_users_block_3_days_ago = User::status()->whereDate('created_at', today()->subDays(3))->count();
        $Charts_users_block_4_days_ago = User::status()->whereDate('created_at', today()->subDays(4))->count();
        $Charts_users_block_5_days_ago = User::status()->whereDate('created_at', today()->subDays(5))->count();
        $Charts_users_block_6_days_ago = User::status()->whereDate('created_at', today()->subDays(6))->count();
        $Charts_users_block_7_days_ago = User::status()->whereDate('created_at', today()->subDays(7))->count();
        // End chart users block
